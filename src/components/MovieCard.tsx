...
import type { OmdbMovie } from "../utils/omdb";
...
export function MovieCard({ data, onDismiss, light = false }: Props) {
      ...
      <div style={s.inner}>
        ...
        <div style={s.mainGrid}>
          <div>
            ...
            <div style={{ ...s.subLine, color: c.muted }}>
            ...
            <div style={s.metaGrid}>
              ...
              >
                <div style={{ ...s.mcLabel, color: c.muted }}>director</div>
                <div style={{ ...s.mcVal, color: c.text }}>{data.Director}</div>
              </div>
            </div>
